...
// Configuration
const CONFIG = {
  baseUrl: 'https://midwestflooring.co/',
  ...
  rules: {
    ...
    '/servicepages/flooring-installation/': { priority: '0.80', changefreq: 'monthly' },
    '/servicepages/vinyl-flooring/': { priority: '0.80', changefreq: 'monthly' },
    '/shop/': { priority: '0.60', changefreq: 'weekly' },
    '/blog/': { priority: '0.60', changefreq: 'weekly' },
